...
{
    public class TestsEntity_ToJsonNoid_entities
    {
        [Fact]
        public void TestToJsonNoid_entities_OK01()
        {
            ...
            // Ejecuta
            string jentities = Entity.ToJsonNoid(monedas);
        ...
        [Fact]
        public void TestToJsonNoid_entities_OK02()
        {
            ...
            // Ejecuta
            string jentities = Entity.ToJsonNoid(entities);
        ...
        [Fact]
        public void TestToJsonNoid_entities_OK03()
        {
        ...
        [Fact]
        public void TestToJsonNoid_entities_OK04()
        {
            ...
            // Ejecuta
            string jentities = Entity.ToJsonNoid(monedas, jfields);
        ...
        [Fact]
        public void TestToJsonNoid_entities_OK05()
        {
            // Prepara (entidades distintos tipos, jfields nulo)
            Moneda moneda1 = new Moneda
            {
            ...
            // Ejecuta
            string jentities = Entity.ToJsonNoid(entities, jfields);
        ...
        [Fact]
        public void TestToJsonNoid_entities_ZBad01()
        {
            ...
            try
            {
                Assert.Throws<NullReferenceException>(() => Entity.ToJsonNoid(entities));
            }
            catch (Exception ex)
            {
        ...
        [Fact]
        public void TestToJsonNoid_entities_ZBad02()
        {
            // Prepara (entidades distintos tipos, jfields nulo)
            Moneda moneda1 = new Moneda
            {
            ...
            try
            {
                Assert.Throws<ArgumentException>( () => Entity.ToJsonNoid(entities, jfields) );
            }
            catch (Exception ex)
            {
                Assert.Equal("(No exception was thrown)", ex.Message);
